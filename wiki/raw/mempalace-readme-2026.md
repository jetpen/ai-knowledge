...
Reproducible — runners in benchmarks - Full results. The 96.6% is from <b>raw verbatim mode, not AAAK or rooms mode (those score lower — see note above
