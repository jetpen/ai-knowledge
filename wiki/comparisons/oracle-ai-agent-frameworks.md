...
Layered stack: business (high speed), integration, data, platform (high flexibility).

| Framework | Layer | Best For | Skip If |
|-----------|-------|----------|---------|
| [[fusion-ai-agent-studio]] | Business | Fusion workflows | Outside Fusion |
| [[oic-ai-agent]] | Integration | Multi-system | Single system |
| [[ai-data-platform-agents]] | Data | Pipelines | Business-process |
